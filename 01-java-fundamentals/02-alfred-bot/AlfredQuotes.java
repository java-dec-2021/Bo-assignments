...
    */
    public String dateAnnouncement() {
        ...
        Date date = new Date();
        return "Todays date is: " + formatter.format(date);
    }
...
    */
    public String respondBeforeAlexis(String conversation) {
        ...
        if (conversation.contains("Alexis")) {
            string = "Right away sir.  She certainly isn't sophisticated enough for that";            
        }
        else if (conversation.contains("Alfred")) {
            string = "At your service.  As you wish naturally";
        }
        else {
            string = "At your service.  And with that I shall retire";
        }
        return string;
    }
    // NINJA BONUS
    ...
    public String ninjaBonus(String testString) {
